...
const DIAL_CODES = {
  ...
  // Territories
  PR: '+1-787', GU: '+1-671', VI: '+1-340', HK: '+852', MO: '+853',
  TK: '+690', AW: '+297', CW: '+599', SX: '+1-721', BM: '+1-441',
  KY: '+1-345', GI: '+350', GL: '+299', FO: '+298', NC: '+687', PF: '+689',
  RE: '+262', GP: '+590', MQ: '+596', GF: '+594', YT: '+262',
}

/**
 * Get the phone dial code for a given ISO country code.
 * @param {string} countryCode - ISO 3166-1 alpha-2 code (e.g., 'PE', 'US')
 * @returns {string} The dial code (e.g., '+51') or '' if not found
 */
